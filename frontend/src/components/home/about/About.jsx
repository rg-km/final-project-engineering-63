...
const About = () => {
  ...
  <p className="abot" style={{textAlign:"justify"}}>Edumar also known as Educational Grammar
  is a website-based english quiz where there are three types of courses namely Vocab, Grammar and Tenses. 
